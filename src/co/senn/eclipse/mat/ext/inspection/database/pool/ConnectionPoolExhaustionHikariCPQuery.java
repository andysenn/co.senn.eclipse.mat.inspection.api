package co.senn.eclipse.mat.ext.inspection.database.pool;
...
import co.senn.eclipse.mat.ext.inspection.AbstractInspection;

@CommandName("suspect:connection-pool-exhaustion-hikaricp")
public class ConnectionPoolExhaustionHikariCPQuery extends AbstractInspection {
